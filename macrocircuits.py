...
Original file is located at
    https://colab.research.google.com/github/neuromatch/NeuroAI_Course/blob/main/projects/project-notebooks/Macrocircuits.ipynb
...
#%% Define the swimmer environments
_SWIM_SPEED = 0.1

swimmer.SUITE.allow_overriding_keys = True
...
#%% Visualize the agent taking random actions
...
#a=render(env)
#a.shape
filename=os.path.join(OUTPUT_DIR,'swimmer_random.mp4')
